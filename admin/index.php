...
?>
    <div class="admin">        
        <div class="inneradmin">
            ...
            <h3 style="font-family: 'Orbitron', sans-serif;color: #8888A0;">Hi Blogger, SPOTcome!</h3>
            </div>
            <form action="<?php $_SERVER["REQUEST_URI"]?>" method="post">
                ...
                <div style="padding-top:30px;"><button type="submit" style="background:#63C8FF" class="forum-btn btn-f">Submit</button></div>                                
            </form>
            <div style="padding-top:30px;">
                <center>
                <h5><a href="forgotpassword.php"> Forgot password?</a> </h5> <br>
                <h5>Not registered yet?<a href="signup.php"> register</a> </h5>
                </center>
            </div>
        </div>
    </div>
